/*
  # Fix for duplicate key in culture_coin_levels table
  
  1. Changes
     - Drop existing culture_coin_levels table if it exists
     - Recreate culture_coin_levels table with all required columns and data
     - Ensure all other tables and functions from previous migration are included
  
  2. Security
     - Re-enable RLS on all tables
     - Recreate all required policies
     
  3. Performance
     - Maintain all indexes from original migration
*/
