    ...
    metrics?.subscriptionTier === 'cultural_architect'
      ...
      : metrics?.subscriptionTier === 'trans_humanist'
        ...
        : metrics?.subscriptionTier === 'seeker'
          ? 'linear-gradient(135deg, #134e4a, #0369a1)'
      ...
      {metrics && (
        <>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            <TrendingUp size={12} style={{ color: '#00ffff' }} />
            <span style={{ color: '#00ffff', fontSize: '0.7rem' }}>Lv.{metrics.currentLevel}</span>
          </div>
          <div style={{ width: 1, height: 16, background: 'rgba(255,255,255,0.15)' }} />
          <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            <Crown size={12} style={{ color: '#a78bfa' }} />
            <span style={{ color: '#a78bfa', fontSize: '0.65rem', textTransform: 'uppercase' }}>
