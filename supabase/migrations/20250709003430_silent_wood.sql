/*
  # Oracle Culture Coin System Setup
  
  1. New Tables
    - `culture_coin_levels` - Level progression system with benefits and multipliers
    - `user_consciousness_metrics` - User's consciousness evolution metrics
    - `oracle_interactions` - Record of user interactions with the Oracle
    - `oracle_subscriptions` - User subscription information
  
  2. Functions
    - `classify_oracle_question` - Categorizes questions as sacred/profane/neutral
    - `calculate_culture_coins` - Calculates coins earned based on question type
    - `process_oracle_interaction` - Processes Oracle interactions and updates user metrics
...
-- Policies for user_consciousness_metrics
...
-- Policies for oracle_subscriptions - fixed the uid() function
